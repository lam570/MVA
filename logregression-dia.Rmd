...
#first we make the prediction then we create a rank column to make it easier to udnerstand by having it in descending order to use in a visualization later, called the rank column
